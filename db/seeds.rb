...
# charity = Charity.create([{ name: "Chabad Coral Springs", link: "https://www.coralspringschabad.org/templates/articlecco_cdo/aid/488285/jewish/DONATE.htm"}])
charity = Charity.create([{ name: "Collel Chabad", link: "https://1.colelchabad.org/Donate_Now.htm?aCampaign=ZDML&%query_string"}])
charity = Charity.create([{ name: "Friednship Circle Montreal", link: "https://www.friendshipcircle.ca/donate"}])
charity = Charity.create([{ name: "Chai Lifeline", link: "https://www.chailifeline.org/donate.php"}])
